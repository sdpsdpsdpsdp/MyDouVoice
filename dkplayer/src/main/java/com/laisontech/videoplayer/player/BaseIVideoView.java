package com.laisontech.videoplayer.player;
...
import com.laisontech.videoplayer.controller.MediaPlayerControl;
import com.laisontech.videoplayer.listener.PlayerEventListener;
import com.laisontech.videoplayer.listener.VideoListener;
import com.laisontech.videoplayer.util.Log;
import com.laisontech.videoplayer.util.ProgressUtil;
...
public abstract class BaseIVideoView extends FrameLayout implements MediaPlayerControl, PlayerEventListener {
    ...
    public BaseIVideoView(@NonNull Context context) {
        this(context, null);
    }


    public BaseIVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseIVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initPlayer() {
        if (mMediaPlayer == null) {
            if (mPlayerConfig.mAbstractPlayer != null) {
                ...
                mMediaPlayer = new IPlayer(getContext());
            }
    ...
    public void onPrepared() {
        ...
        if (mCurrentPosition > 0) {
            Log.d("seek to:" + mCurrentPosition);
